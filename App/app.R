...
ui <- fluidPage(
  ...
  # App title ----
  titlePanel("How do different hyperparameter tuning procedures impact model predictive performance and computational time?"),
  ...
  sidebarLayout(
    sidebarPanel = sidebarPanel(
      radioButtons(
        ...
        choices = list(
          "Study 1 (selecting hyperparameters)" = "Study1",
          "Study 2 (optimisation criteria)"     = "Study2",
