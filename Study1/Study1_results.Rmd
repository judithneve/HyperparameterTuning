...
```{r}
save(plot_ex_met, summary_table_study1, mean_AUC_splitrule, mean_AUC_nosplitrule, sd_AUC_splitrule, sd_AUC_nosplitrule, summary_table_study1_sc, failed_1, failed_1_re, file = "Data/results.RData")
```
