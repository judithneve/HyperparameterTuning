job_args <- Sys.getenv("SLURM_ARRAY_TASK_ID")
print(job_args)
...
# randomly pick one of the included scenarios
# sampled_scenario <- (1:12)[included_scenarios]
# if (length(sampled_scenario) > 1) {
#   sampled_scenario <- sample(sampled_scenario, 1)
# }
# scenarios      <- scenarios[sampled_scenario,]
scenarios      <- scenarios[job_id,]
