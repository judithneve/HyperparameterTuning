...
(summary_table_study1 %>% 
  mutate(AUC = paste0(AUC_mean, " (", AUC_sd, ")"),
         ...
         Runtime = paste0(Runtime_mean, " (", Runtime_sd, ")")) %>% 
  select(`Tuned hyperparameters`, AUC, `Calibration slope`, `RMSD(slope)`, Runtime) %>% 
