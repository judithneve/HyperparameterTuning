...
betas_pilot <- betas_matrix[[1]][3,] %>% round(2) # select only the regression coefficients we used in this pilot
```
...
# validation of betas: can they be recovered with a GLM?
...
# get the largest difference between the estimated beta and the true beta
...
```{r}
# load the data generated by Study1_pilot.Rmd
load("Data/pilot.RData")
