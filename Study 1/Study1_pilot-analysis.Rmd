...
ggsave("Plots/plot_grouped.jpg", width = 30, height = 15, units = "cm")
```
...
# ggsave("Plots/plot_grouped_top3.jpg", width = 30, height = 15, units = "cm")
```
...
all_perf %>%
  ...
  #                           values_to = "Performance"),
  #            size = 3)
# ggsave("Plots/plot_facetted.jpg", width = 90, height = 40, units = "cm")
```
