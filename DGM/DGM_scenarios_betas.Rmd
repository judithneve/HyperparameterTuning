...
save(beta_estimations, validation_betas_matrix, file = "Data/betas_validation.RData")
```
...
```{r}
writeLines(capture.output(sessionInfo()), "Output/DGM_scenarios_betas_sessionInfo.txt")
```
