...
# ggsave("./../Study1/Output/study1fig.pdf", height = 8, width = 6)
```
...
plot_ex_met
# ggsave("./../Study2/Output/study2fig.pdf", height = 8, width = 6)
```
...
plot_ex_same
# ggsave("./../Study2/Output/study2extra.pdf", height = 8, width = 6)
```
...
# ggsave("./../Study3/Output/s3time.pdf", height = 8, width = 6)
```
...
plot_ex_met
# ggsave("./../Study3/Output/study3fig.pdf", height = 8, width = 6)
```
